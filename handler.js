    ...
    try {
        ...
        try {
            ...
            if (settings) {
                ...
                if (!('gif' in settings)) settings.gif = true
...
let mssg = {
        rowner: '_FITUR INI KHUSUS DEVELOPER, USER TIDAK DAPAT MENGAKSESNYA_ 🗿👍:!',
        owner: '_FITUR INI KHUSUS OWNER KINTIL KAU BUKAN OWNER_ 🗿🔪 :!',
        mods: '_FITUR INI KHUSUS MODERATOR KAU SIAPA MEK_ ⚡🔪'}[type]
...
let msg = {
        premium: '_KAU GA PREMIUM SEMPAK, PREMIUM DULU SONO_🗿👍',
        group: '_FITUR KHUSU DI GROUP MEK_ 🗿👍',       
        botAdmin: '_BOT TIDAK ADMIN JEMBOT JADIIN ADMIN DULU PEK_ 🗿🔪',
        admin: '_KHUSUS ADMIN GROUP WAK KAU SIAPA USER YAHAA_🗿🔪',
        restrict: 'Batasi Tidak Diaktifkan Untuk Obrolan Ini'}[type]
  ...
  if (msg) return conn.sendMessage(m.chat, {
    ...
    let daftar = {
  unreg: `╭📌ʜᴀɪ ᴋᴀᴋ, ᴛᴏʟᴏɴɢ ʀᴇɢɪsᴛʀᴀsɪ ᴛᴇʀʟᴇʙɪʜ ᴅᴀʜᴜʟᴜ sᴇʙᴇʟᴜᴍ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ʙᴏᴛ!\n\n╭─ •  「 *ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ*  」\n│  ○  *_ᴍᴀɴᴜᴀʟ_* : .ʀᴇɢɪꜱᴛᴇʀ name.18\n│\n│  ○  ᴅᴀꜰᴛᴀʀ ᴏᴛᴏᴍᴀᴛɪꜱ ᴋᴇᴛɪᴋ *@ᴠᴇʀɪꜰʏ*\n│\n│  ○  ᴅᴀꜰᴛᴀʀ ᴍᴇʟᴀʟᴜɪ ᴇᴍᴀɪʟ .ʀᴇɢᴍᴀɪʟ\n╰──────────────\n\n\n*𝙽𝚘𝚝𝚎* : 𝙼𝚎𝚗𝚐𝚊𝚋𝚊𝚒𝚔𝚊𝚗 𝚙𝚎𝚜𝚊𝚗 𝚒𝚗𝚒 𝚜𝚎𝚋𝚊𝚗𝚢𝚊𝚔 *𝟻𝚡* 𝚔𝚊𝚖𝚞 𝚊𝚔𝚊𝚗 𝚍𝚒 𝚋𝚊𝚗𝚗𝚎𝚍 𝚍𝚊𝚗 𝚍𝚒 𝚋𝚕𝚘𝚔𝚒𝚛, 𝚞𝚗𝚝𝚞𝚔 𝚖𝚎𝚖𝚋𝚞𝚔𝚊 𝚋𝚊𝚗𝚗𝚎𝚍 𝚍𝚊𝚗 𝚋𝚕𝚘𝚔𝚒𝚛 𝚍𝚒𝚔𝚎𝚗𝚊𝚒 𝚋𝚒𝚊𝚢𝚊 𝚜𝚎𝚋𝚎𝚜𝚊𝚛 𝚁𝚙. 𝟻,𝟶𝟶𝟶,𝟶𝟶𝟶,𝟶𝟶𝟶`}[type]
  ...
  if (daftar) return conn.sendMessage(m.chat, {
      ...
      body: 'lakukan registrasi terlebih dahulu',
